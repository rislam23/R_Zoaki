...
<body>
  ...
  <div class="jumbotron" style="margin-top:40px">
    ...
    <p class="lead text-center">Whenever you or your friend think about to adopt a pet for your family, animal shielter is the very first stop you should think of instead spending hundred dollars to purchase a pet from a store.
          Remember, No trade No killing</p>
  </div>

  <div class="container" style="margin-top:30px">
    <div class="row mb-2">
      <div class="col-md-3">
          <span class="mb-2 position-fixed btn-sub" style="z-index: 999; right: 30px; bottom: 30px" data-toggle="modal" data-target="#formModal2">
  ...
  <div class="container">
    ...
    <div id="formModal2" class="modal fade" role="dialog">
      ...
      <?php include 'php_includes/adopt_form.php'; ?>
